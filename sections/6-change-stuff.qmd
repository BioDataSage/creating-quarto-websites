...
knitr::include_graphics(here::here("media", "no-about-page.png"))
```
...
knitr::include_graphics(here::here("media", "with-about-page.png"))
```
...
knitr::include_graphics(here::here("media", "full-page.png"))
```
...
#| fig-align: center
#| fig-cap: ""
knitr::include_graphics(here::here("media", "no-page-title.png"))
```
:::
...
knitr::include_graphics(here::here("media", "resources-page.png"))
knitr::include_graphics(here::here("media", "resources-page-renamed.png"))
```
...
knitr::include_graphics(here::here("media", "light.png"))
```
...
knitr::include_graphics(here::here("media", "dark.png"))
```
