...
#| echo: false
#| fig-align: center
knitr::include_graphics(here::here("media", "positron-command-palette-quarto-proj.png"))
```
...
#| layout-ncol: 2
#| column: page
knitr::include_graphics(here::here("media", "positron-website-project.png"))
knitr::include_graphics(here::here("media", "positron-choose-project-directory.png"))
```
...
#| echo: false
#| fig-align: center
knitr::include_graphics(here::here("media", "positron-directory-name.png"))
```
...
#| echo: false
#| fig-align: center
knitr::include_graphics(here::here("media", "positron-explorer.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("media", "positron-preview.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("media", "positron-preview-browser.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("media", "positron-initialize-git-repo.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("media", "positron-initial-commit.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("media", "positron-start-session.png"))
```
...
```{r}
#| echo: false
knitr::include_graphics(here::here("media", "positron-graph-initial-commit.png"))
```
...
```{r}
#| echo: false
knitr::include_graphics(here::here("media", "positron-create-remote.png"))
```
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("media", "mysite-remote.png"))
```
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(here::here("media", "GH_quick_setup_options.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(here::here("media", "mysite-remote-cli.png"))
```
