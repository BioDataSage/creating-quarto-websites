...
#| fig-align: center
#| out-width: "100%"
knitr::include_graphics(here::here("media", "rmd-vs-qmd.png"))
```
...
#| fig-align: center
#| out-width: "100%"
knitr::include_graphics(here::here("media", "rmd-vs-qmd-output.png"))
```
:::
...
knitr::include_graphics(here::here("media", "quarto_schematic.png"))
```
