...
knitr::include_graphics(here::here("media", "gh-pages.png"))
knitr::include_graphics(here::here("media", "rendered_site.png"))
```
...
```{r}
#| echo: false
knitr::include_graphics(here::here("media", "actions-tab.png"))
```
:::
